                        ...
                        <div class="card-shadow">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="about" rows="10" id="about" class="d-block w-100 form-control" >{{$item->about}}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="duration" id="duration" class="form-control" placeholder="Durations" value="{{$item->duration}}">
                                </div>
                                <div class="form-group">
